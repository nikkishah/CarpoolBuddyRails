...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { grade: @child.grade, highschool: @child.highschool, name: @child.name, passcode: @child.passcode, sex: @child.sex }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { grade: @child.grade, highschool: @child.highschool, name: @child.name, passcode: @child.passcode, sex: @child.sex }
    assert_redirected_to child_path(assigns(:child))
  end
